...
--
-- Host: localhost
-- Generation Time: Apr 05, 2016 at 12:34 AM
...
CREATE TABLE IF NOT EXISTS `places` (
  ...
  `place_type` int(100) NOT NULL DEFAULT '15',
...
(1, 29, 'Hummum Falls', 'This mystical water fall lies deep into the Rajkandi Reserve Forest. The water way (jhiri poth) of Hummum Falls is fascinating. The hills and the surrounding forest make this place an ideal camping site for the adventure seekers.', NULL, NULL, NULL),
(2, 29, 'Rechhang falls', 'Rechhang is one of the popular tourist destination of Khagrachori. Reasang bus stoppage is available around 10 km before Khagrachori town on Chitagong – Khagrachori highway. From there one have to go another 2.1 km to Reach Rechhang Water Falls.', NULL, NULL, NULL),
(3, 29, 'Toiduchori Jharna', 'This waterfall is situated in one of the most remote area in Dhiginala, Khagrachori. It is also known as Shibchori Jharna. Recently it has been discovered. So there is no traditional trails to go there. You may have to create your own path to go there.All the way it is too dangerous and slippery(for rainy season). You have to climb two hills as well as have to cross a tribal village and jhiri path. Approximately you have to walk 16-20km for day long.', NULL, NULL, NULL),
(4, 29, 'Zingsiam Saitar Waterfall', 'Zingsiam saitar is one of the beautiful waterfall in Bangladesh,which has three different steps.Zingsiam saitar is situated near Rumana para.one of the uniqueness of Zingsiam saitar or Rumanapara is that,you will able to visit three waterfall within short distance and within short time (3.5 -4 hours).', NULL, NULL, NULL),
(5, 29, 'Sohostro Dhara', 'Sahastradhara meaning “thousand fold spring” is a beautiful waterfall in Chittagong', NULL, NULL, NULL),
(6, 29, 'Amiakum waterfall', 'Amiakum is one of the beautiful waterfall in Bangladesh.it’s near Bangladesh Myanmar Boder.This waterfall is situated in one of the most remote area in Bandarban.There is different way to go Amiakum.', NULL, NULL, NULL),
(7, 29, 'Nafakhum', 'Remakri khal originates from Myanmar enters into our country and meets shangu river. At one place of remakri khal there is a sudden fall of height of about 25-30feet and forms Nafakhum. The place where it meets Shangu River known as remakrikhum which is also beautiful. There are 3-4 steps where water rolls down.', NULL, NULL, NULL),
(8, 29, 'Rijuk Waterfall', 'Rijuk jiri/Rijuk Jhorna/Rijuk Waterfall/Ruma waterfall is a very nice and huge waterfall with awesome natural beauty that can be accessed easily without a long trekking.', NULL, NULL, NULL),
(9, 29, 'Shailo Propat', NULL, NULL, NULL, NULL),
(10, 29, 'Chingri Jharna', 'Chingry Jharna is next to Bogalake,Bandarban. get it in the trek of bogalake to Keokradong', NULL, NULL, NULL),
(11, 29, 'Patang Jhiri', 'a water fall that would be found in the Jhiri trek of Bogalake/ Keokradong. Some Bengali guide named Nirjhara by Bangali guides', NULL, NULL, NULL),
(12, 29, 'Baklai Waterfall', 'Baklai waterfall is situated near (1.4 kilometer Arial , bearing 170˚ true) of Baklai Para, Mouza- Naiting , PS- Thanchi , District – Bandarban. Basically the Baklai Para Have been named after the waterfall.', NULL, NULL, NULL),
(13, 29, 'Faipi Falls', 'Faipi Waterfalls is situated near Thaikang Para (2.5km arial distance approx.).\n', NULL, NULL, NULL),
(14, 29, 'Midingachhori Waterfall\n', 'This waterfall is located at Midingachhori of Rangamati. It has 3 steps having different lengths. This is a live waterfall, and it used to produce water more or less throughout the year.\n\n', NULL, NULL, NULL),
(15, 29, 'Jadipai falls', 'One of he most beautiful waterfalls in Bangladesh', NULL, NULL, NULL),
(16, 11, 'St. Martin’s Island', 'St. Martin’s Island (Local name Narikeldia or Narikel Zinzira) is the only coral island’s of Bangladesh. The island is only 8Sq. Km measured. It has nice sandy beaches, coral reef and adjoining small island Cheradia or CheraDwip. ', NULL, NULL, NULL),
(17, 11, 'Kutubdia Island', 'Kutubdia is located at 21.8167°N 91.8583°E. It has 14,463 households and a total area of 215.8 square kilometres (83.3 sq mi). Climate change and sea level rise threaten to submerge the island in the Bay of Bengal.[1]', NULL, NULL, NULL),
(18, 8, 'Chandranath HIll Temples', 'The famous Chandranath Temple & Buddhist temples are in Sitakundu, 37 km for from Chittagong city. Famous among the many temples in this place, the Chandranath Temple and the Buddhist Temple has a footprint of Lord Buddha.', NULL, NULL, NULL),
(19, 2, 'Parki Char Beach', 'Main attraction here is sandy sea beach having 15 kilometers length and 350 feet width. To see ship port and outer anchorage where big ships are anchored is excellent. Moreover, Jhaw forest, fishing in sea, sunset in sea, various colorful crabs moving around the beach will charm you.', NULL, NULL, NULL),
(20, 2, 'Cox''s Bazar', 'Cox''s Bazar is one of the most attractive tourist spots & the longest sea beach in the world (approx. 120 km long). Miles of golden sands, towering cliffs, surfing waves, rare conch shells, colorful pagodas, Buddhist temples and tribes, delightful seafood--this is Cox''s Bazar, the tourist capital of Bangladesh.', NULL, NULL, NULL),
(21, 2, 'Himchori and Inani Beach', 'Himchori is famous for waterfall, though in the winter season it dwindles but during the rainy season it’s really a fabulous and full waterfall can be enjoyed. Inani beach is famous for the rock and coral boulders; you will find big coral boulders in this beach.', NULL, NULL, NULL),
(22, 11, 'Moheshkhali Island', 'You will find mangrove forests, hilly areas, salt field etc. This island is famous for Buddhist Temple and Pagoda; ', NULL, NULL, NULL),
(23, 4, 'War Cemetery', 'In this well-preserved cemetery at a quiet and picturesque place within the city lie buried in eternal peace over 700 soldiers from British, Australia, Canada, New Zealand, India, Myanmar, East and West Africa, The Netherlands and Japan who laid down their lives on the Myanmar front during the World War II.', NULL, NULL, NULL),
(24, 17, 'Zia memorial Museum', 'This museum is rather unexpectedly housed in a mock-Tudor mansion. Among its much-revered collection is the microphone and transmitter with which President Zia proclaimed the country’s independence in 1971.', NULL, NULL, NULL),
(25, 17, 'Ethnological Museum', 'This museum located in Agrabad is a treasure house of a variety of tribal culture and heritage of Bangladesh', NULL, NULL, NULL),
(26, 17, 'Court Building Museum', 'Situated on the Fairy Hill, this building commands a panoramic bird''s eye view of Chittagong. This had been the scene of intense activity during the independence War in 1971. A museum has been established here.', NULL, NULL, NULL),
(27, 24, 'Shrine of Hazrat Bayezead Bostami', 'The shrine of this famous saint is situated in Chittagong. Its shrine area as a complex consists of a tomb surrounded by a brick structure along with an old mosque and a large pond.', NULL, NULL, NULL),
(28, 24, 'Shrine of Shah Amanat', 'The Shrine of Shah Amanat is another place of religious attraction, located in the heart of the town; the shrine is visited by hundreds of people everyday who pay homage to the memory of the saint.', NULL, NULL, NULL),
(29, 12, 'Fays Lake ', 'This lake is a natural beauty of Chittagong, where you can enjoy boating and also you can spend your leisure time in a serene atmosphere of lake and hills.', NULL, NULL, NULL),
(30, 2, 'Patenga and Fouzdarhat Sea Beaches', 'Patenga beach is about 22 km. from Chittagong and is approachable by a motorable road. On the way to the beach, one passes the Patenga Airport. Another ideal picnic spot is the Fouzdarhat sea-beach about 16 km. from Chittagong.', NULL, NULL, NULL),
(31, 23, 'Port Area', 'Located near the river mouth of the river Karnaphuli, the Chittagong port has a recorded history from 9th century. Today, this is the principal seaport of the country. ', NULL, NULL, NULL),
(32, 24, 'The Aggameda Khyang', 'Equally elaborate in plan, elevation and decoration is the Aggameda Khyang near the entrance to the Cox''s Bazar town, which nestles at the foot of a hill under heavy cover of a stand of large trees. The main sanctuary-cum-monastery is carried on a series of round timber columns, which apart from accommodating the prayer chamber and an assembly hall, also is the repository of a large of small bronze Buddha images-mostly of Burmese origin-- and some old manuscripts.', NULL, NULL, NULL),
(33, 23, 'Ramu', 'This is a typical Buddhist village, about 16 km. from Cox''s Bazar, on the main road to Chittagong. There are monasteries, khyangs and pagodas containing images of Buddha in gold, bronze and other metals inlaid with precious stones.', NULL, NULL, NULL),
(34, 23, 'Teknaf', 'The side of river Naf and the Bay of Bengal situate Teknaf Town, which is the southernmost tip of Bangladesh. It’s a real natural beauty of hills, forest & Naf River. Lots of Salt fields are there by the side of River Naf. There are natural waterfalls in Teknaf, which increases the beauty of nature.', NULL, NULL, NULL),
...
(36, 23, 'Rangamati', 'If you don’t visit Rangamati you will not discover a big portion of natural beauties of Bangladesh. From Chittagong a 77 km. road amidst green fields and winding hills will take you to Rangamati. It is also connected by waterway from Kaptai. ', NULL, NULL, NULL),
(37, 12, 'Kaptai Lake', 'Built in early sixties Kaptai Dam and the lake are the main attractions of Kaptai. If you are not visiting Kaptai separately then, don’t forget to go for a boating up to Kaptai on the Kaptai Lake while you go to Rangamati tour.', NULL, NULL, NULL),
(38, 23, 'Khagrachari', 'Khagrachhari is the natural wild beauty of Bangladesh. Here you can visit the tribal lifestyle of Chakmas’ in Khagrachari. You can also visit Alutila hill. Approximately 100 meters long a very dark Cave is the mysterious beauty of Alutila hill.', NULL, NULL, NULL),
...
(40, 23, 'Bandarban', 'Lots of hills and hilly areas, waterfalls, River Sangu, Lakes and the tribal culture are the main attraction of Bandarban ', NULL, NULL, NULL),
(41, 11, 'Sonadia Island', 'This island is situated at the Bay of Bengal near another prominent island Moheshkhali, north-west of Cox’s Bazar. The island is covered with mangrove trees and vegetation, mudflats and sandy beach. Most of the people living there are fishermen. There is very little agricultural activity only to provide food for the locality.\n\n', NULL, NULL, NULL),
(42, 11, 'Nijhum Dwip Island', 'Nijhum Dwip means, Silent Island (Bengali: নিঝুম দ্বীপ) is a small island under Hatiya upazila. It is situated in Noakhali District in Bangladesh. Once it was called as Char Osman', NULL, NULL, NULL),
(43, 23, 'Comilla', 'The main attractions of Comilla are Bangladesh Academy for Rural Development (BARD), the home of famous Comilla Approach to rural development, Lalmai and Maynamoti hills, Shalban Monastery, Maynamoti museum and Comilla Zoo. ', NULL, NULL, NULL),
(44, 23, 'Bangladesh Academy for Rural Development', 'This is one of the main attractions in Comilla. This is one of the richest academic institutions for conducting research and action research', NULL, NULL, NULL),
(45, 23, 'Lalmai Moinamoti and Shalbon Bihar', 'They are famous historical and archeological places around Comilla. These are a series of hillocks, where the Northern part is called Moinamoti and the Southern part is called Lalmai; and Shalbon Bihar is in the Middle of Lalmai and Moinamoti, which the was established in 8th century by King Buddadev. ', NULL, NULL, NULL),
(46, 25, 'Ahsan Manjil', 'Basically, it was the residence of the Nawabs. Nawab Abdul Gani renovated this building in the year 1872 and named it after his son Khaza Ahasanullah.', NULL, NULL, NULL),
(47, 6, 'Lalbagh Fort', 'The fort of Aurangabad, popularly known as the Lalbagh Fort, was built in 1678 AD by the then Viceroy of Bengal Prince Mohammad Azam, son of the Mughal Emperor Aurangazeb. ', NULL, NULL, NULL),
(48, 27, 'Central Shahid Minar', 'This monument was built to commemorate the martyrs of the historic Language movement of 1952.', NULL, NULL, NULL),
(49, 17, 'Bangladesh national museum', 'The museum contains a large number of interesting collections including sculptures and paintings', NULL, NULL, NULL),
(50, 17, 'Bangabandhu memorial museum', 'The residence of the father of the nation Bangabandhu Sheikh Mujibur Rahman has been turn in to a museum', NULL, NULL, NULL),
(51, 17, 'Mukti juddha museum', 'This is the museum on our liberation war which is well known as mukti juddha', NULL, NULL, NULL),
(52, 17, 'Science museum', 'modern learning cente', NULL, NULL, NULL),
(53, 14, 'Shadhinota Stambha', 'Shadhinota Stambha is the place where Bangabondhu Sheikh Mujibur Rahman Delivered his historical speech on 7th march 1971', NULL, NULL, NULL),
(54, 14, 'National Poet''s Graveyard', 'Revolutionary poet Kazi Nazrul Islam died on the 29 August 1976 and was buried here.', NULL, NULL, NULL),
(55, 20, 'Suhrawardy Uddyan (Garden)', 'A Popular Park.', NULL, NULL, NULL),
(56, 13, 'Mausoleum of National Leaders', 'Its located at the southwestern corner of Suhrawardy Uddyan, it is the eternal resting place of great national leaders', NULL, NULL, NULL),
(57, 19, 'Banga-Bhaban', 'The official residence of the President, located in the city.', NULL, NULL, NULL),
(58, 21, 'Parliament House', 'Jatiya Sangsad Bhaban (Parliament House) located at Sher-e-Bangla Nagar has distinctive architectural features', NULL, NULL, NULL),
(59, 20, 'Ramna Park', 'A vast stretch of green garden ', NULL, NULL, NULL),
(60, 10, 'Institute of Arts and Crafts', 'Situated in the picturesque surroundings of Shahbagh. ', NULL, NULL, NULL),
(61, 1, 'Curzon Hall', 'Beautiful architectural building named after Lord Curzon.', NULL, NULL, NULL),
(62, 14, '1857 Memorial', '(Bahadur Shah Park) Built to commemorate the martyrs of the first liberation war (1857-59) against British rule', NULL, NULL, NULL),
(63, 9, 'Old High Court Building', 'Originally built as the residence of the British Governor', NULL, NULL, NULL),
(64, 30, 'National Zoo', 'National Zoo is in Mirpur, 20 km. from the center of Dhaka besides the river Turag', NULL, NULL, NULL),
(65, 16, 'Mosque of Baba Adam', 'Of a slightly later date, the elegant 6-domed mosque (43''x36'') of Baba Adam in Rampal near Dhaka was erected by one Malik Kafur during the reign of the last llyas Shahi Sultan, Jalauddin Fateh Shah in 1483 A.D', NULL, NULL, NULL),
(66, 9, 'Sonargaon', 'On the Dhaka-Chittagong highway about 29 km from Dhaka, Sonargaon is one of the oldest capitals of Bengal', NULL, NULL, NULL),
(67, 14, 'National Martyrs Memorial', 'This Martyrs Memorial is a symbol of Bengali nationalism. ', NULL, NULL, NULL),
(68, 20, 'Bhawal National Park', 'It is a vast (1,600 acres) national recreational forest with Picnic spots; ', NULL, NULL, NULL),
(69, 3, 'Bangabandhu Bridg', 'It is a real beauty at nights when sodium lights lighten the bridge.', NULL, NULL, NULL),
(70, 13, 'Tungipara, Bangabandhu Mausoleum Complex', 'Here is the graveyard of great Sheikh Mujibur Rahman the father of our national who was killed in the year 1975, 15th August.', NULL, NULL, NULL),
(71, 22, 'Modhupur Picnic Spot', 'It is a forest park where lots of picnic party comes in winter season.', NULL, NULL, NULL),
(72, 22, 'Susang Durgapur', 'Susang Durgapur is 182 km from Dhaka, a real natural beauty of forest river & hills area where the Garos and other tribal live. ', NULL, NULL, NULL),
(73, 26, 'Gajni Parjatan Center', 'Gajni Parjatan Center is 220 km far from Dhaka. Where you will find the natural beauty of hills, lakes, forest & lots of birds here, it is a natural tourist spot where you can see the tribal life of our tribes.', NULL, NULL, NULL),
(74, 18, 'Jaflong', 'Jaflong is one of the most attractive tourist spot in Bangladesh situated at Bangladesh-India border.where you will find waterfall,river,hills', NULL, NULL, NULL),
(75, 7, 'Tanguar Haor', 'The Haor is located close to the hills of Meghalaya and changes its flavor of beauty in different seasons.Every winter the haor is home to about 200 types of migratory birds.', NULL, NULL, NULL),
(76, 29, 'Hum Hum waterfall', 'It is one of the largest waterfall in Bangladesh.', NULL, NULL, NULL),
(77, 18, 'Laurer Garh', 'It is a captivating spot with slopes fitting in distinctive layers, trees with diverse shades of green and obviously a waterway going by them.', NULL, NULL, NULL),
(78, 18, 'Lalakhal', 'The river ‘Sari’ at Lalakhal is the main tourist attraction here. The boat trip over the river is an exceptional experience.', NULL, NULL, NULL),
(79, 18, 'Bisnakandi', 'This place is famous for river surrounded by hills covered with thick green vegetation.', NULL, NULL, NULL),
(80, 18, 'Jadukata River & Barek Tila', 'Jadukata River is an ultimate beauty of nature.This river changes its flavor of beauty in different seasons of the year. During monsoon the water is blue and clear and you can see the river bed.', NULL, NULL, NULL),
(81, 18, 'Madhabpur Lake', 'It is a lake surrounded by Tea garden.', NULL, NULL, NULL),
(82, 18, 'Shagar Dighi', 'it is a water reservoir.', NULL, NULL, NULL),
(83, 18, 'Tekerghat Limestone Quarry', 'Tekerghat is a natural reservoir of limestone.', NULL, NULL, NULL),
(84, 29, 'Madhabkunda Waterfall', 'one of the largest waterfall in bangladesh.', NULL, NULL, NULL),
(86, 29, 'Pang Thu Mai and Barahill Falls', 'The Barahill falls is located actually in between Bangladesh-India border. The waterfall belongs to India and the lake belongs to Bangladesh. ', NULL, NULL, NULL),
(87, 29, 'Parikunda Waterfall', 'Beautifull waterfall surrounded by hills.', NULL, NULL, NULL),
(88, 7, 'Baikka Beel', 'It is mainly a large waterland', NULL, NULL, NULL),
(89, 7, 'Hakaluki Haor', 'One of the largest waterland in bangladesh.', NULL, NULL, NULL),
(90, 5, 'Rajkandi Reserve Forest', 'This is mainly a rain forest', NULL, NULL, NULL),
(91, 5, 'Ratargul Swamp Forest', 'This is only swamp forest in Bangladesh', NULL, NULL, NULL),
(92, 5, 'Khadimnagar National Park', 'it is a reserve forest', NULL, NULL, NULL),
(93, 5, 'Tilagar Eco Park', 'This forest is mainly an Eco park', NULL, NULL, NULL),
(94, 5, 'Madhabkunda Eco Park', 'This forest is mainly an Eco park', NULL, NULL, NULL),
(95, 5, 'Lawachara Rain Forest', 'This is mainly a rain forest', NULL, NULL, NULL),
(96, 5, 'Rema-Kalenga Wildlife Sanctuary', 'It is mainly a protected forest', NULL, NULL, NULL),
(97, 5, 'Shatchari National Park', 'Forest of various type of naturally growing trees', NULL, NULL, NULL),
(98, 28, 'Malnichara Tea Estate', 'This is mainly a tea garden', NULL, NULL, NULL),
(99, 28, 'Lakkatura Tea Garden', 'This is mainly a tea garden', NULL, NULL, NULL),
(100, 28, 'Bangladesh Tea Research Institute (BTRI)', 'Tea research institute of Bangladesh and largest tea garden..', NULL, NULL, NULL),
(101, 9, 'Ali Amjad’s Clock', 'This is a big clock tower', NULL, NULL, NULL),
(102, 9, 'Shahi Eidgah', 'This is mainly a prayer hall', NULL, NULL, NULL),
(103, 9, 'Baniachong- The Largest Rural Settlement in Asia', 'Largest rural settlement in Asia', NULL, NULL, NULL),
(104, 17, 'Museum Of Rajas', 'This museum has collection of poem,noble and song written by famous Ruller Hasan raja ', NULL, NULL, NULL),
(105, 17, 'Osmani Museum', 'This museum has collection of achivement''s,memories of Commander-in-Chief of Bangladesh Forces in the 1971 Liberation War', NULL, NULL, NULL),
(106, 29, 'Hummum Falls', 'This mystical water fall lies deep into the Rajkandi Reserve Forest. The water way (jhiri poth) of Hummum Falls is fascinating. The hills and the surrounding forest make this place an ideal camping site for the adventure seekers.', NULL, NULL, NULL),
(107, 29, 'Ateka Falls', 'Ateka Falls is one of the most beautiful waterfall in Bangladesh,which has TEN different steps. Before now no team visited over there. This mystical water fall lies deep into the Rajkandi Reserve Forest. The water way (jhiri poth) of Ateka Falls is fascinating. The hills and the surrounding forest make this place an ideal camping site for the adventure seekers. one of the uniqueness of Ateka falls is that, it has ten steps from ground. And this is the only Bangladeshi falls which has 10 steps. If anyone wants to go there, he/she have to pass these most beautiful steps.', NULL, NULL, NULL);
...
INSERT INTO `placetype` (`placetype_id`, `name`, `Description`) VALUES
(1, 'Architectural Landmark', 'N/A'),
(2, 'Beach', 'N/A'),
(3, 'Bridge', 'N/A'),
(4, 'Cemetery', 'N/A'),
(5, 'Forest', 'N/A'),
...
(16, 'Mosque', 'N/A'),
(17, 'Museum', 'N/A'),
(18, 'Natural beauty', 'N/A'),
(19, 'Official Residence', 'N/A'),
(20, 'Park', 'N/A'),
(21, 'Parliament', 'N/A'),
(22, 'Picnic Spot', 'N/A'),
(23, 'POI', 'N/A'),
(24, 'Religious Place', 'N/A'),
(25, 'Residence of Nawabs', 'N/A'),
(26, 'Resort', 'N/A'),
(27, 'Symbol of Bengali Nationalism', 'N/A'),
(28, 'Tea garden', 'N/A'),
(29, 'Waterfall', 'Waterfall...'),
(30, 'Zoo', 'N/A');
...
--
ALTER TABLE `placetype`
  MODIFY `placetype_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
